    ...
    messages: [
      ...
      },
      {
        ...
        content: [
          ...
          "Use stable keys req_01, req_02, ... in causal dependency order.",
          "When the Objective needs diagnosis plus a changed controlled output,",
          "first require an owned-context diagnosis that establishes what the",
          "company can support and what remains unknown. If the outcome then",
          "depends on evidence the company does not control, make availability",
          "of that evidence its own required truth BEFORE the final controlled",
          "artifact/output that depends on it. Do not choose MAKE/BUY/provider",
          "here; requirements state truths, not strategies.",
