...
export function FixtureWorkspace({ initialScenario = "launch", initialMoment }: { initialScenario?: string; initialMoment?: string }) {
  ...
  return <MissionControl view={snapshot.view}
    ...
    inspection={<><EvidenceInspector view={snapshot.view} /><details className="mc-xray-toggle"><summary>System X-ray · secondary inspection</summary><SystemXray xray={buildXray(snapshot.view)} /></details></>}
